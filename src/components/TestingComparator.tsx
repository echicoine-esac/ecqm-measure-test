            ...
            {isMobile ? (
              ...
              !items || items?.size === 0 ? (
                <div className='card-body'>
                  ...
                  <label tabIndex={0}>
                    <span aria-hidden="true">This utility compares current Measure evaluations done in real-time with previous MeasureReports from MADiE (<a href='https://ecqi.healthit.gov/tool/madie' target='_blank' rel='noreferrer'>https://ecqi.healthit.gov/tool/madie ↗</a>) and displays a summary of discrepancies and matches. The existing MeasureReports are pulled from the Data Repository server, and the current Measure Evaluation will be executed against the selected Measure Evaluation Server. To begin, verify the following items are established:</span>
                    <span className='screen-reader-only'>{'This utility compares current Measure evaluations done in real-time with previous MeasureReports from MADiE and displays a summary of discrepancies and matches. The existing MeasureReports are pulled from the Data Repository server, and the current Measure Evaluation will be executed against the selected Measure Evaluation Server. To begin, verify the following items are established: a measure, a data repository server, an established patient group for the measure, and a measure evaluation server.'}</span>
                  </label>
